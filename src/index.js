...
app.post('/api/payroll/users', async (c) => {
  ...
  const newUser = {
    ...
    baseSalary: sanitizeNumber(body.baseSalary || body.grossSalary || body.ctc, 25000),
    grossSalary: body.grossSalary ? sanitizeNumber(body.grossSalary) : null,
    ctc: body.ctc ? sanitizeNumber(body.ctc) : null,
    basicPerDay: body.basicPerDay ? sanitizeNumber(body.basicPerDay) : null,
    otRate: body.otRate ? sanitizeNumber(body.otRate) : null,
    salaryComponents: body.salaryComponents || {},
    deductionRates: body.deductionRates || {},
    employerContributions: body.employerContributions || {},
    ...
    aadhar: sanitizeAlphanumeric(body.aadhar, 30),
    pan: sanitizeAlphanumeric(body.pan, 30),
